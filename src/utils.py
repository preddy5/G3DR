...
def sample_front_circle(camera_params, num_frames):
    trajectory = EasyDict({'name': 'front_circle', 'num_frames': num_frames, 'fov_diff': 0.0, 'yaw_diff': 0.25, 'pitch_diff': 0.1, 'use_mean_camera': True})
